...
- Live refresh across open tabs/windows in the same browser session
...
- Because this project is frontend-only, true instant sync between two different devices is not possible without adding a shared backend or realtime service.
